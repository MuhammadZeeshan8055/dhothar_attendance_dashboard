...
$where = "employee_leaves.status='Applied'";
$limit = 0;
                ...
                <div class="container-fluid">
                        ...
                        <div class="mb-4 mb-md-0">
                            ...
                            <nav aria-label="breadcrumb">
                                <ol class="breadcrumb mb-0">
                                    ...
                                    <li class="breadcrumb-item active" aria-current="page">Applied Leave</li>
                                </ol>
                            </nav>
                        </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <a href="add_leave" class="btn btn-success">Add Leave</a>
