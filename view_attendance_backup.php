                                        ...
                                        <tbody>
                                            ...
                                            if (!empty($result)) {
                                                ...
                                                "end_time"=>$end_time,"worked_hours"=>$worked_hours,'overtime'=>$overtime)) {
                                                    ...
                                                    // Parse time parts from string like "1 H, 01 m, 00 s"
                                            ...
                                            <?php
                                                ...
                                                $total_worked = sprintf('%d H, %02d m, %02d s', $total_hours, $total_minutes, $total_secs);

                                                ?>
                                                    <tr>
                                                        <td colspan="4" class="text-end"><strong>Total Worked Hours:</strong></td>
                                                        <td colspan="2"><strong><?=$total_worked?></strong></td>
                                                    </tr>
                                                <?php
                                            }else{
                                                ?>
