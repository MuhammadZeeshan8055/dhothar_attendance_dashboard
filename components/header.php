        ...
        <div class="with-vertical">
          ...
          <nav class="navbar navbar-expand-lg p-0">
            ...
            <div class="d-block d-lg-none py-4 py-xl-0">
              <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/logos/light-logo.svg" alt="Logo" />
            </div>
                      ...
                      <div class="message-body" data-simplebar>
                        <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                          <span class="user-img position-relative d-inline-block">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-5.jpg" alt="user" class="rounded-circle w-100 round-40" />
                        ...
                        <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                          <span class="user-img position-relative d-inline-block">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-3.jpg" alt="user" class="rounded-circle w-100 round-40" />
                        ...
                        <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                          <span class="user-img position-relative d-inline-block">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-6.jpg" alt="user" class="rounded-circle w-100 round-40" />
                        ...
                        <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                          <span class="user-img position-relative d-inline-block">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-7.jpg" alt="user" class="rounded-circle w-100 round-40" />
                            <span class="position-absolute top-0 start-100 translate-middle p-1 bg-success border border-light rounded-circle">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                            </button>
                        ...
                        <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                          <span class="user-img position-relative d-inline-block">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-8.jpg" alt="user" class="rounded-circle w-100 round-40" />
                            <span class="position-absolute top-0 start-100 translate-middle p-1 bg-success border border-light rounded-circle">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                        ...
                        <a href="javascript:void(0)" class="p-3 pe-0 d-flex align-items-center dropdown-item gap-3 border-bottom">
                          <span class="user-img position-relative d-inline-block">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-9.jpg" alt="user" class="rounded-circle w-100 round-40" />
                            <span class="position-absolute top-0 start-100 translate-middle p-1 bg-warning border border-light rounded-circle">
                              <span class="visually-hidden">New alerts</span>
                            </span>
                          </span>
                  ...
                  <li class="nav-item dropdown">
                    <a class="nav-link" href="javascript:void(0)" id="drop1" aria-expanded="false">
                      <div class="d-flex align-items-center lh-base">
                        <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/profile/user-1.jpg" class="rounded-circle" width="35" height="35" alt="monster-img" />
                      </div>
                    </a>
                    <div class="dropdown-menu content-dd dropdown-menu-end animated flipInY" aria-labelledby="drop1">
                      <div class="profile-dropdown position-relative" data-simplebar>
                        ...
                        <div class="d-grid py-4 px-7 pt-8">
                          <a href="http://localhost/dhothar_attendance_dashboard/login.php" class="btn btn-info">Log Out</a>
                        </div>
                      </div>
            ...
            <nav class="sidebar-nav scroll-sidebar">
              <div class="offcanvas-header justify-content-between ps-0 pt-0">
                <div class="brand-logo d-flex align-items-center">
                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/index.html" class="text-nowrap logo-img">
                    <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/logos/dark-logo.svg" alt="Logo" class="dark-logo" />
                    <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/logos/light-logo.svg" alt="Logo" class="light-logo" />
                  </a>
                </div>
                  ...
                  <li class="sidebar-item">
                    ...
                    <ul aria-expanded="false" class="collapse first-level my-3 ps-3">
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-chat.html" class="d-flex align-items-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-invoice.html" class="d-flex align-items-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-contact2.html" class="d-flex align-items-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-email.html" class="d-flex align-items-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/page-user-profile.html" class="d-flex align-items-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-calendar.html" class="d-flex align-items-center">
                          <div class="bg-primary-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-contact.html" class="d-flex align-items-center">
                          <div class="bg-secondary-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                      ...
                      <li class="sidebar-item py-2">
                        <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-notes.html" class="d-flex align-items-center">
                          <div class="bg-warning-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
          ...
          <nav class="navbar navbar-expand-xl container-fluid p-0">
            <ul class="navbar-nav align-items-center">
              ...
              <li class="nav-item d-none d-xl-flex align-items-center">
                <a href="https://bootstrapdemos.wrappixel.com/monster/dist/horizontal/index.html" class="text-nowrap nav-link">
                      ...
                      <div class="row">
                        <div class="col-8">
                          <div class="p-4 pb-3">
                            <div class="row">
                              <div class="col-6">
                                <div class="position-relative">
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-chat.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="bg-primary-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:chat-line-linear" class="text-primary fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                                  ...
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-invoice.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="bg-secondary-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:bill-list-linear" class="text-secondary fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                                  ...
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-contact2.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="bg-warning-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:bedside-table-2-linear" class="text-warning fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                                  ...
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-email.html" class="d-flex align-items-center position-relative">
                                    <div class="bg-danger-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:letter-unread-linear" class="text-danger fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                              ...
                              <div class="col-6">
                                <div class="position-relative">
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/page-user-profile.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="bg-success-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:cart-large-2-linear" class="text-success fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                                  ...
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-calendar.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="bg-primary-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:calendar-linear" class="text-primary fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                                  ...
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-contact.html" class="d-flex align-items-center pb-9 position-relative">
                                    <div class="bg-secondary-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:bedside-table-linear" class="text-secondary fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                                  ...
                                  <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-notes.html" class="d-flex align-items-center position-relative">
                                    <div class="bg-warning-subtle rounded-circle round me-3 d-flex align-items-center justify-content-center">
                                      <iconify-icon icon="solar:palette-linear" class="text-warning fs-5"></iconify-icon>
                                    </div>
                                    <div class="d-inline-block">
                        ...
                        <div class="col-4 ms-n3">
                          <div class="position-relative p-3 border-start h-100">
                            ...
                            <ul>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/page-pricing.html">Pricing Page</a>
                              </li>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/authentication-login.html">Authentication Design</a>
                              </li>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/authentication-register.html">Register Now</a>
                              </li>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/authentication-error.html">404 Error Page</a>
                              </li>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-notes.html">Notes App</a>
                              </li>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/page-user-profile.html">User Application</a>
                              </li>
                              <li class="mb-3">
                                <a class="fs-3" href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/page-account-settings.html">Account Settings</a>
                              </li>
                            </ul>
                          </div>
                        </div>
            ...
            <div class="d-block d-xl-none">
              <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/index.html" class="text-nowrap nav-link">
                <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/logos/light-logo.svg" alt="Logo" />
              </a>
            </div>
            <ul class="navbar-nav navbar-toggler p-0 border-0">
                ...
                <ul class="navbar-nav flex-row mx-auto ms-lg-auto align-items-center justify-content-center">
                  ...
                  <li class="nav-item dropdown nav-icon-hover-bg rounded-circle">
                    <a class="nav-link" href="javascript:void(0)" id="drop2" aria-expanded="false">
                      <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/flag/icon-flag-en.svg" alt="monster-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                    </a>
                    <div class="dropdown-menu dropdown-menu-end dropdown-menu-animate-up overflow-hidden" aria-labelledby="drop2">
                      <div class="message-body">
                        ...
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/flag/icon-flag-cn.svg" alt="monster-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                          </div>
                          <p class="mb-0 fs-3">中国人 (Chinese)</p>
                        </a>
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/flag/icon-flag-fr.svg" alt="monster-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                          </div>
                          <p class="mb-0 fs-3">français (French)</p>
                        </a>
                        <a href="javascript:void(0)" class="d-flex align-items-center gap-2 py-3 px-4 dropdown-item">
                          <div class="position-relative">
                            <img src="https://bootstrapdemos.wrappixel.com/monster/dist/assets/images/flag/icon-flag-sa.svg" alt="monster-img" width="20px" height="20px" class="rounded-circle object-fit-cover round-20" />
                          </div>
                  ...
                  <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu content-dd dropdown-menu-end animated flipInY" aria-labelledby="drop1">
                      <div class="profile-dropdown position-relative" data-simplebar>
                        ...
                        <div class="message-body">
                          <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/page-user-profile.html" class="py-8 px-7 mt-8 d-flex align-items-center">
                          ...
                          <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-email.html" class="py-8 px-7 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center bg-info-subtle rounded p-6 fs-7 text-info">
                          ...
                          <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/app-kanban.html" class="py-8 px-7 d-flex align-items-center">
                            <span class="d-flex align-items-center justify-content-center bg-info-subtle rounded p-6 fs-7 text-info">
                        ...
                        <div class="d-grid py-4 px-7 pt-8">
                          <a href="https://bootstrapdemos.wrappixel.com/monster/dist/minisidebar/authentication-login.html" class="btn btn-info">Log Out</a>
                        </div>
                      </div>
